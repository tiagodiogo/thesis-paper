...
its vision of connecting every device to one another presents an opportunity to create large informa-tion sharing networks. However, intruders can take advantage of the IoT devices constrained nature
to disrupt the networks and launch a wide range of attacks on its nodes.
